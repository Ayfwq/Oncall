...
REALTIME_MARKERS = ('当前', '现在', '最近', '实时', '状态', '日志', 'log', '指标', 'cpu', '内存', '磁盘', '进程', '容器', '健康', 'health', '接口', 'api')
OPS_MARKERS = ('docker', 'linux', 'postgres', '数据库', '备份', '部署', '安装', '故障', '异常', '日志', 'log', '监控', '服务', '容器', '进程', '网络', '磁盘', 'cpu', '内存', 'api', '告警', '排查', '运维', '恢复')
