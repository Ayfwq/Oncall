...
PYTHON_SIGNALS = (
    ...
    "host.disk.read_bytes_per_sec",
    "host.disk.write_bytes_per_sec",
    ...
    "process.target.virtual_memory_bytes_sum",
    "process.target.open_fds_sum",
    "process.target.uptime_seconds",
)

PYTHON_GPU_SIGNALS = (
    "host.gpu.exporter.up",
    "host.gpu.available",
    "host.gpu.utilization_percent",
    "host.gpu.memory_percent",
    "host.gpu.temperature_celsius",
    "host.gpu.power_watts",
)
