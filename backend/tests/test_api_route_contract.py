...
('GET','/api/incidents'),('GET','/api/incidents/{iid}'),('DELETE','/api/incidents/{iid}'),('POST','/api/incidents/{iid}/investigate'),('POST','/api/incidents/{iid}/resolve'),('POST','/api/incidents/{iid}/conversation'),('GET','/api/incidents/{iid}/trace'),
